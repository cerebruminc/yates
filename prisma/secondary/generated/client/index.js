...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Volumes/owc-express-1m2/projects/yates/prisma/secondary/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "dffad0c54f09c97448a1f9151db3633557cdb705ac2be8a6d8f0a49e6302dc24",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/secondary/generated/client",
    "secondary/generated/client",
  ]
...
path.join(process.cwd(), "prisma/secondary/generated/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/secondary/generated/client/schema.prisma")
